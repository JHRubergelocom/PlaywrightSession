...
public class PlaywrightSessionTest {
    ...
    private List< TabPage> editEmployee1() {
        ...
        tableLine.add(new ELOControl("IX_MAP_HR_PERSONNEL_FAMILYMEMBER_TYPE", "Ehepartner", ELOControlType.KWL));
        ...
        controls.add(new ELOControl("befristet", "true", ELOControlType.RADIO));
...
*/
    ...
    private List< TabPage> createME1() {
        ...
        controls.add(new ELOControl("IX_GRP_MEETING_LOCATION", "Musterstadt", ELOControlType.TEXT));
...
*/
    ...
    private List< TabPage> createME1Premium() {
        ...
        controls.add(new ELOControl("IX_GRP_MEETING_LOCATION", "Musterdorf", ELOControlType.TEXT));
...
*/
    ...
    @ParameterizedTest
    @ValueSource(strings = {"DataConfigMeeting.json"})
