...
*/
    ...
    public void testLocator() {
        ...
        BaseFunctions.sleep();
        BaseFunctions.selectByTextAttribute(page, "Neue Organisation", "id", "comp").get().click();
        ...
        BaseFunctions.sleep();
        BaseFunctions.selectByTextAttribute(page, "Organisation erweitern", "id", "comp").get().click();
